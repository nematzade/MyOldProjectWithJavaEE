...
<div  align="center" class="easyui-panel" title="ورود به سیستم" style="width:100%;max-width:400px;padding:30px 60px;" >
    ...
    <form action="/action/auth/login">
        <div style="margin-bottom:10px">
            <input class="easyui-textbox" name="username" style="width:100%;height:40px;padding:12px" data-options="prompt:'نام کاربری',iconCls:'icon-man',iconWidth:38,required:true">
        </div>
        <div style="margin-bottom:20px">
            <input class="easyui-textbox" name="password" type="password" style="width:100%;height:40px;padding:12px" data-options="prompt:'رمز عبور',iconCls:'icon-lock',iconWidth:38,required:true">
        </div>
        <%--<div style="margin-bottom:20px">--%>
